    ...
    <div className="d-flex flex-column justify-content-between" style={{ minHeight: '100vh' }}>
      ...
      <Container className="mt-5 mb-4">
        ...
        <Row className="justify-content-center">
          ...
          <Col xs={6} md={6} className="text-center">
            <img
              src="https://wallpapercave.com/wp/MUlF14y.jpg"
              alt="Slot 2"
              className="img-fluid"
              data-value="Product2"
        ...
        <Row className="mt-3 justify-content-center">
          <Col xs={6} md={6} className="text-center">
            <img
              src="https://munkong.sgp1.cdn.digitaloceanspaces.com/munkong-production/2022-05-18/1652929493298.jpg"
              alt="Slot 3"
              className="img-fluid"
              data-value="Product3"
          ...
          <Col xs={6} md={6} className="text-center">
            <img
              src="https://www.boonlapo.com/wp-content/uploads/2021/05/logo-bang-olufsen.jpg"
              alt="Slot 4"
              className="img-fluid"
              data-value="Product4"
              style={{ height: "110%", width: "auto" , border: "10px solid black" }}
      ...
      <footer className="d-flex flex-wrap justify-content-center align-items-center py-3 my-4 border-top">
        <div className="col-md-4 d-flex align-items-center justify-content-center">
          <a
            href="/"
            className="mb-3 mt-4 me-2 mb-md-0 text-muted text-decoration-none lh-1"
          >
